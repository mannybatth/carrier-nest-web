...
const CreateNewButton: React.FC<CreateNewButtonProps> = ({ className, collapsed }) => {
    ...
    return (
        <div className={className}>
            <button className="flex items-center justify-center w-full px-3 py-2.5 mb-4 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white">
