...
const SettingsLayout: React.FC<SettingsLayoutProps> = ({ children, title, maxWidth = '3xl' }) => {
    ...
    const sidebarClasses = `hidden md:block md:fixed md:inset-y-0 ${settingsSidebarLeft} md:w-64 bg-gradient-to-b from-slate-50 to-gray-100 border-r border-gray-200 shadow-sm z-20 transition-all duration-300 ease-in-out`;
