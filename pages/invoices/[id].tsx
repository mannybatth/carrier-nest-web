        ...
        >
            <>
                <SimpleDialog
                    ...
                    primaryButtonAction={() => deleteInvoice(invoice.id)}
                    secondaryButtonAction={() => setOpenDeleteInvoiceConfirmation(false)}
                    onClose={() => setOpenDeleteInvoiceConfirmation(false)}
                ></SimpleDialog>
                <SimpleDialog
                    show={openDeletePaymentConfirmation}
                    ...
                    secondaryButtonAction={() => {
                        setOpenDeletePaymentConfirmation(false);
                                                                                        ...
                                                                                        {({ active }) => (
                                                                                            <a
                                                                                                onClick={(e) => {
                                                                                                    ...
                                                                                                    setOpenDeletePaymentConfirmation(
                                                                                                        true,
                                                                                                    );
                                                                                                }}
                                                                                                className={classNames(
